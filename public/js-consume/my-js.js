...
$('.view_edit_gaji').click(function(){
     const data_id_gaji = $(this).data('id');
     const data_gaji = $(this).data('gaji');

     $('#data_id_gaji').val(data_id_gaji)
     $('.data_gaji').val(data_gaji)
...
$('.view_data_exel_absensi').click(function(){
     const data_id  = $(this).data('flashdata')
     ...
     $("#modal-create-absensi-exel").modal('show')
     // $('#modal-create-karyawan-exel').modal({backdrop: 'static', keyboard: false})  
...
$('.view_data_exel_kurir').click(function(){
     const data_id_kurir  = $(this).data('flashdata')
        
     $("#data_id_kurir").val(data_id_kurir);

     $("#modal-create-karyawan-exel-kurir").modal({
               backdrop: 'static',
               keyboard: true
     }); 

     $("#modal-create-karyawan-exel-kurir").modal('show')
     // $('#modal-create-karyawan-exel').modal({backdrop: 'static', keyboard: false})  
...
$('.hapus_resign').on('click', function(e) {
     e.preventDefault();
     const hrefUrl_= $(this).attr('href')
   
     $("#btn-hapus_resign").on("click", function(e){
          e.preventDefault();
          document.location.href=hrefUrl_;
     });
