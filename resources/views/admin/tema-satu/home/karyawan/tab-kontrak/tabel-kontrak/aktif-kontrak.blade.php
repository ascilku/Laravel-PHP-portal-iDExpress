...
<!-- ======================== Modal edit kontrak ============================== -->
<div class="modal modal-blur fade" id="modal-edit-kontrak-aktif" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                {{ csrf_field() }}
                      <div class="modal-body">
                                <input type="hidden" class="form-control" id="data_id_kontrak_aktif" name="id_kontrak" placeholder="Your report name">
                 
                                   
                                <div class="mb-3">
                                    <label class="form-label">Nama Karyawan</label>
                                    <input type="text" class="form-control bg-menu" id="data_nama_kontrak_aktif"  readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="data_tanggal_awal_kontrak_aktif" name="mulai" required>
                                    <span id="file_error" class="text-danger font-size-info-alert"></span>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label required">Akhir Kontrak</label>
                                    <input type="date" class="form-control" id="data_tanggal_akhir_kontrak_aktif" name="akhir" required>
                                    <span id="file_error" class="text-danger font-size-info-alert"></span>
                                </div>
...
<div class="modal modal-blur fade" id="lihat-kontrak" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="col-md-12 col-xl-12">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="card-title mb-1 " ><span id="data_lihat_nama"></span></div>
                    <div class="text-muted" id="data_lihat_nik">VP Sales</div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-6 col-sm-6 text-center "> Jenis : 
                                <span class="badge bg-info me-1 ">
                                    <div class="text-muted "><span class="font-color-white" id="data_lihat_jenis"></span></div>
                                </span>
                            </div>
                            <div class="col-xl-6 col-md-6 col-sm-6 "> Akhir Kontrak: 
                                <span class="badge bg-danger me-1 ">
                                    <div class="text-muted "><span class="font-color-white" id="data_lihat_tanggal_akhir"></span></div>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                {{ csrf_field() }}
                    <input type="hidden" id="data_lihat_id" name="id_">
...
<div class="modal modal-blur fade" id="modal-kontrak" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Buat Kontrak df</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                                    ...
                                    ?>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                ...
                                                <!-- <td>  
                                                        <a href="#" class="view_edit_kontrak_aktif" 
