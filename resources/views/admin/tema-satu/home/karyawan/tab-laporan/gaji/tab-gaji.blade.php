            ...
            <?php if (Session::get('alert-success-karyawan')): ?>
                ...
                <div class="card">
                    <ul class="nav nav-tabs" data-bs-toggle="tabs">
                        ...
                        <li class="nav-item ">
                            <a href="{{route('absensi', 'new')}}" class="nav-link <?php  echo ($key=='new' ? 'active' : '');?> "><span class="badge bg-info ms-auto icon-login " class="">New</span> Gaji</a>
                        </li>

                        <li class="nav-item">
                            <a href="{{route('absensi', 'history')}}" class="nav-link <?php  echo ($key=='history' ? 'active' : '');?> "><span class="badge bg-danger ms-auto icon-login " class="">History</span> Gaji</a>
                        </li>
                        ...
                        <div class="tab-content">
                            ...
                            <?php if ($key == 'new'): ?>
                                <div class="tab-pane active show" id="tidak">
                                    @include('admin.tema-satu.home.karyawan.tab-laporan.gaji.gaji')
                                </div>
