                            ...
                            <div class="row">
                              <div class="col-md-12 col-xl-12">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK..." value="" readonly>
                                      <span id="nik_error" class="text-danger font-size-info-alert"></span>
                                    </div>

                                    <div class="mb-3">
                                      <label class="form-label required">Email Aktif</label>
                                      <input type="email" class="form-control" id="email" name="email" placeholder="Email Aktif..." value="" readonly>
                              ...
                              <div class="col-md-12 col-xl-12">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <div class="card-body  text-center">
                                      ...
                                      <img src="{{ asset('') }}static/avatars/profil.png" id="gambar_nodin" class="avatar avatar-xl mb-3 avatar-rounded" style="width: 200px; height: 200px;" />
                                    </div>
