                         ...
                         <div class="col-xl-12 col-md-12 top-cv-">
                              <div class="row divide-y">
                                   <!-- <div class=" bg-menu">
                                        ...
                                        <div class="col-md-12 col-xl-12 divide-y">
                                             <div class="table-responsive">
                                                  ...
                                                  <!-- $dahboard_jabatan_id->jabatan->nama_jabatan; -->
                                                            <?php foreach ($tunjangan_lihat_rwt as $key_dahboard_jabatan): ?>
                                                                 <?php
                                                                      $tunjangan_sekarang = $tunjangan_id->id;
                                                                      $tunjangan_pembanding = $key_dahboard_jabatan->id;
                                                                 ?>

                                                                 <tr>
                                                                      <td>{{$key_dahboard_jabatan->akun->data_diri->nama_lengkap}}</td>
                                                                      <td>{{$key_dahboard_jabatan->tunj_jabatan}}</td>
                                                                      <td>{{$key_dahboard_jabatan->tunj_kendaraan}}</td>
                                                                      <td>{{$key_dahboard_jabatan->pendapatan_lain}}</td>
                                                                      <td></td>
                                                                      <td></td>
                                                                      <?php if ($tunjangan_sekarang == $tunjangan_pembanding ): ?>
                                                                           <td><span class="badge bg-info me-1">Tunjagan Sekarang</span></td>
                                                                      <?php else: ?>
                                                                           <td><span class="badge bg-danger me-1">Tunjagan History</span></td>
                                                                      <?php endif ?>
                                                                      <?php if ($dahboard_akun_cookie->akses->akses == 'Admin' ): ?>
                                                                           <?php if ($tunjangan_sekarang == $tunjangan_pembanding ): ?>
                                                                                <td></td>
                                        ...
                                        <!-- <?php if (count($tunjangan_lihat_rwt) == 0): ?>
                                        <?php else: ?>
                                             <div class="col-md-12 col-xl-12 divide-y">
                                                  <div class="table-responsive">
                                                       <table class="table table-vcenter card-table font-size-cv-">
