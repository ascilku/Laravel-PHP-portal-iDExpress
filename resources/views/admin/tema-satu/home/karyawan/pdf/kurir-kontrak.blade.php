...
<body>
         ...
         <table style="width: 100%;" border="1">
            <tr>
                ...
                <td class="mid" style="width: 40%;" colspan="2" >
                    <h3 style="padding: 0; margin-top: 5;">{{strtoupper($dahboard_akun_cookie->perusahaan->nama)}}</h3>
                    <p class="mid" style="font-size: 14px;margin-top: -15px;">{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->alamat))}}, Kelurahan. {{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kelurahan))}}, Kecamatan {{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kecamatan))}}, Kota {{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kabupaten))}}, Provinsi {{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->provinsi))}}.</p>
    ...
    <main  style="margin-top: 0px;">
        <div style="page-break-after: always; page-break-after: never;">
            ...
            <h5 class="mid" style="margin-top: -15; margin-bottom: 30px;">PENEMPATAN,TUGAS dan TANGGUNG JAWAB</h5>
            ...
            <br>
            <!-- PASAL 2 -->
            <h5 class="mid" style="width: 48%; margin:0 auto; padding-top: 0px; margin-top: 20px">PASAL 2</h5>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Tunjangan BBM</td>
                                <td>:</td>
                                <td>Rp <?= number_format(240000, 0, ',', '.');  ?>(Rp. 60.000/minggu dengan bukti Nota Print Asli)</td>
                            </tr>
                            <tr>
                                <td>h.</td>
                                <td>Tunjangan Pulsa & Paket Data</td>
                                <td>:</td>
                                <td>Rp <?= number_format(50000, 0, ',', '.');  ?>(Dengan bukti Nota Asli)</td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <!-- PASAL 5 -->
            <h5 class="mid" style="width: 48%; margin:0 auto; margin-top: 0px; padding-top: 15px;">PASAL 5</h5>
            ...
            <!-- PASAL 9 -->
            <h5 class="mid" style="width: 48%; margin:0 auto; padding-top: 10px;">PASAL 9</h5>
            ...
            <!-- PASAL 11 -->
            <h5 class="mid" style="width: 48%; margin:0 auto; margin-top: 0%;">PASAL 11</h5>
