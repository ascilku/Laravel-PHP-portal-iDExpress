         ...
         <table style="width: 100%;" border="1">
            <tr>
                ...
                <td class="mid" style="width: 40%;" colspan="2" >
                    <h3 style="padding: 0; margin-top: 5;">PT {{strtoupper($dahboard_akun_cookie->perusahaan->nama)}}</h3>
                    <p class="mid" style="font-size: 14px;margin-top: -15px;">{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->alamat))}}, Kel.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kelurahan))}}, Kec.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kecamatan))}}, Kota.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kabupaten))}}, Prov.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->provinsi))}}.</p>
        ...
        <div style="page-break-after: always; page-break-after: never;">
            ...
            <table>
                <tr>
                    ...
                    <td class="kk">  
                        <span class="bold"><b>PT {{ucwords(strtolower($dahboard_akun_cookie->perusahaan->nama))}}</b></span> suatu perseroan terbatas yang didirikan berdasarkan hukum di Indonesia, berkedudukan di <b>{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->alamat))}}, Kel.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kelurahan))}}, Kec.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kecamatan))}}, Kot.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->kabupaten))}}, Prov.{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->provinsi))}}</b>, dalam hal ini diwakili oleh <b>{{ucwords(strtolower($dahboard_akun_cookie->perusahaan->data_perusahaan->nama_pemilik))}}</b> selaku <span class="bold hitam">General Manager</span> , untuk selanjutnya disebut <span style="font-weight: bold; font-size: 13px;">"PIHAK PERTAMA".</span>
                    </td>
                </tr>
                <tr>
                    <td></td>
            ...
            <table style="margin-top: 15px; margin-bottom: 0;">
                ...
                <tr>
                    <td class="top">4.</td>
                    <td class="indent "><span style="font-weight: bold; font-size: 13px;">PIHAK KEDUA</span> wajib mengembalikan seluruh sarana dan prasarana kerja milik <span style="font-weight: bold; font-size: 13px;">PIHAK PERTAMA</span> dalam keadaan baik serta menyelesaikan seluruh tanggung jawab yang diemban <span style="font-weight: bold; font-size: 13px;">PIHAK KEDUA</span> kepada <span style="font-weight: bold; font-size: 13px;">PIHAK PERTAMA</span> saat berakhirnya hubungan kerja akibat berakhirnya kontrak atau pemutusan hubungan kerja </td>
                </tr>
                <tr>
                    <td class="top">5.</td>
            ...
            <!-- PASAL 8 -->
            <h5 class="mid" style="width: 48%; margin:0 auto; padding-top: 30px;">PASAL 8</h5>
            ...
            <!-- PASAL 10 -->
            <h5 class="mid" style="width: 48%; margin:0 auto; margin-top: 0px; padding-top: -10px;">PASAL 10</h5>
