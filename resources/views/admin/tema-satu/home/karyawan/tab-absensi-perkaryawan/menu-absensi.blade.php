                ...
                <div class="card">
                    <ul class="nav nav-tabs" data-bs-toggle="tabs">
                        ...
                        <?php if ($key == 'new' || $key == 'new-kehadiran' || $key == 'history-kehadiran'): ?>
                            <li class="nav-item ">
                            <a href="{{route('absensi-diri', 'new')}}" class="nav-link <?php  echo ($key=='new' ? 'active' : '');?> ">Absensi</a>
                        </li>
                        <?php elseif ($key == 'history'): ?>
                            <li class="nav-item ">
                            <a href="{{route('absensi-diri', 'history')}}" class="nav-link <?php  echo ($key=='history' ? 'active' : '');?> ">Absensi</a>
                        </li>
                        <?php endif ?>
                        ...
                        <li class="nav-item ">
                            <a href="{{route('kehadiran-absensi-diri', 'new-kehadiran')}}" class="nav-link <?php  echo ($key=='new-kehadiran' || $key=='history-kehadiran' ? 'active' : '');?> ">Kehadiran</a>
                        ...
                        <div class="tab-content">
                            ...
                            <?php if ($key == 'new' || $key == 'history'): ?>
                                <div class="tab-pane active show" id="tidak">
                                    @include('admin.tema-satu.home.karyawan.tab-absensi-perkaryawan.tab-absensi')
                                </div>
                            <?php elseif ($key == 'new-kehadiran' || $key == 'history-kehadiran'): ?>
                                <div class="tab-pane active show" id="tidak">
                                    @include('admin.tema-satu.home.karyawan.tab-kehadiran-karyawan.tab-kehadiran')
                                </div>
                            <?php endif ?>
