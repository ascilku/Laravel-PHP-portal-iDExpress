                                ...
                                <?php endif ?>
                                    ...
                                    <div class="card">
                                        <ul class="nav nav-tabs" data-bs-toggle="tabs">
                                            ...
                                            <li class="nav-item">
                                                <a href="#karyawan" class="nav-link active" data-bs-toggle="tab">Perusahaan</a>
                                            </li>
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active show" id="karyawan">
                                                    @include('admin.tema-satu.home.perusahaan.tab-perusahaan.tab-menu-perusahaan.tab-menu')
                                                </div>
